...
public class sem2details extends JPanel {
	sem2details()
	{
		Dimension size;
		Insets i = getInsets();
...
//	JTextField  = new JTextField();
    ...
    add(subl);
	 ...
	 add(fromtime);
	    ...
	    fromtimel.setBounds( 35 + i.left, 100  + i.top , 150 + size.width , 10 + size.height);
	    add(fromtimel);
	...
	/////////////////// copied code starts here
			    ...
			    add1.addActionListener(new ActionListener() {
							...
							tempo.add(j1);
							 ...
							 while(r.next())
							 {
								 ...
								 if( k1 > k && k1 < m && m1 > k && m1<m)
									 ...
									 try
									 {
										 s.executeUpdate("insert into thirdsemtimetable values ('" +(ia)+ "','"+r.getString(1)+"')");
			    	...
			    	///trial ends
			    final String query2 = "delete from thirdsemtimetable";        
