...
public class sem3details extends JPanel {
	sem3details()
	{
		Dimension size;
		Insets i = getInsets();
		    ...
		    add(totimel);
			 ...
			 add(date);
			    ...
			    add1.addActionListener(new ActionListener() {
							...
							tempo.add(j1);
							 ...
							 while(r.next())
							 {
								 ...
								 if( k1 > k && k1 < m && m1 > k && m1<m)
									 ...
									 try
									 {
										 s.executeUpdate("insert into fifthsemtimetable values ('" +(ia)+ "','"+r.getString(1)+"')");
			    	...
			    	///trial ends
			    final String query2 = "delete from fifthsemtimetable";        
