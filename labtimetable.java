...
public class labtimetable extends JPanel {
	
	public labtimetable(final String a) {
	...
	*/
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			try
			{
			    ...
			    //System.out.println("Connected to Oracle Database");
				 ...
				 String query = "insert into labtimetable values ('"+a+"','"+days+"','"+sems+"','"
	...
	ResultSet r = null;
			...
			String temp = null;
	 String res = null;
	 final String query = "delete from labtimetable where username  ='"+a+"'";
